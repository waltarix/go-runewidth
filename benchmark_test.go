...
func BenchmarkRuneWidthAll(b *testing.B) {
	benchSink = benchRuneWidth(b, 0, utf8.MaxRune+1, 1431185)
}
func BenchmarkRuneWidth768(b *testing.B) {
	benchSink = benchRuneWidth(b, 0, 0x300, 716)
}
...
func BenchmarkString1WidthAll(b *testing.B) {
	benchSink = benchString1Width(b, 0, utf8.MaxRune+1, 1435281)
}
func BenchmarkString1Width768(b *testing.B) {
	benchSink = benchString1Width(b, 0, 0x300, 716)
}
